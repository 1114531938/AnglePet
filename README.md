...
- JWT Bearer Token 鉴权；前端使用会话存储，关闭当前标签页或浏览器后需要重新登录。
...
- 完整营销落地页、登录注册页和控制台。
- 独立价格方案、常见问题和安全合规页面。
- 价格页支持月付/年付方案切换；当前仅展示套餐，不接入真实支付或自动扣费。
- 角色卡片、状态展示、角色详情和模型配置。
...
![AnglePet 价格方案](docs/images/pricing.png)
...
│   │   ├── pricing/page.tsx  # 免费体验与陪伴价格方案
│   │   ├── faq/page.tsx      # 常见问题
│   │   ├── about/page.tsx    # 安全与合规说明
